...
<body>
    ...
    <div class="div-conteudo">
        <form method="POST" action="logica/processamento.php">
            ...
            <input type="text" name="inputTemp1" placeholder="Digite a temperatura">
            <select name="selectTemperatura">
                <option value="fahrenheit">De Celsius para Fahrenheit</option>
                <option value="celsius">De Fahrenheit para Celsius</option>
            </select>
